...
from mace_dipole_core.modules.utils import extract_invariant
from mace_dipole_core.tools import torch_geometric, torch_tools, utils
...
class MACECalculator_dipole(Calculator):
    """MACE ASE Calculator
    args:
