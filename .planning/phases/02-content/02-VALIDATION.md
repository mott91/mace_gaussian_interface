...
- **Before `/gsd:verify-work`:** Generator runs clean, slide count is 12, content verified
...
| CONT-02 | 01 | 1 | CONT-02 | smoke | Count slides: expect 12 | ✅ via pptx parse | ⬜ pending |
...
| Spectrum plots legible at slide scale | CONT-03 | Image embedding quality requires visual check | Open pptx, zoom into spectrum slide, verify labels are readable |
