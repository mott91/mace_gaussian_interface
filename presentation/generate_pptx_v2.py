...
def slide_architecture(prs):
    content_slide(prs, "$ python3 main.py  # system architecture", [
        ...
        ("  │  • load_geometry()  • mace_omol.optimize()  • ase_to_gjf │", DIM),
        ("  └──────────────┬────────────────────────┬──────────────────┘", DIM),
        ("                 │                        │", DIM),
        ("                 ▼                        ▼", DIM),
        ("  ┌──────────────────────┐  ┌────────────────────────────────┐", DIM),
        ...
        ("  │  • gaussian_freq()   │  │  • launch_gaussian()           │", DIM),
        ("  │  • gaussian_dipoles()│  │  • zmq_dipole_loop()           │", DIM),
        ("  │  • parse_gaussian()  │  │                                │", DIM),
        ("  └──────────┬───────────┘  └───────────────┬────────────────┘", DIM),
        ("             │                              │", DIM),
        ("             ▼                              ▼", DIM),
        ...
        ("  │  load_results → find_dft_baseline → eigenvector_matching │", DIM),
        ("  │  → kde_broaden → calculate_metrics → plot_regression     │", DIM),
        ("  └─────────────────────────┬────────────────────────────────┘", DIM),
        ("                            ▼", DIM),
